...
public enum TokenType implements Serializable {
   ...
   * This type is associated with byte size values with units, such as "1GB", "2.5MiB".
   ...
   * This type is associated with time duration values with units, such as "5m", "1.5h".
   * Supports various time units: ns, us, ms, s, m, h, d, w, mo, y.
   */
  TIME_DURATION
}
